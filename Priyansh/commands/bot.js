...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
   ...
   if ((event.body.toLowerCase() == "Kamina") || (event.body.toLowerCase() == "sala")) {
       return api.sendMessage("𝐆𝐀𝐋𝗶𝗶 𝐍𝐀 𝐃𝐄 𝐒𝐀𝐌𝐄𝐄𝐑 𝐁𝐀𝐁𝐔 𝐊𝐎 𝐁𝐀𝐓𝐀 𝐃𝐔𝐍𝐆𝐢 🙄🙄🙏", threadID);
     };
   ...
   if ((event.body.toLowerCase() == "funny") || (event.body.toLowerCase() == "songs")) {
    ...
    if ((event.body.toLowerCase() == ".und") || (event.body.toLowerCase() == ".unsand")) {
      ...
      if ((event.body.toLowerCase() == "🤗") || (event.body.toLowerCase() == "🤗")) {
       return api.sendMessage("😻🌿𝐘𝐀𝐇𝐀 𝐍𝐀𝐇𝐈 𝐈𝐁 𝐂𝐇𝐀𝐋𝐎💐😻", threadID);
     };
   ...
   if ((event.body.toLowerCase() == "🙏") || (event.body.toLowerCase() == "🙏🙏")) {
    ...
    if ((event.body.toLowerCase() == "ashii") || (event.body.toLowerCase() == "ayehsa")) {
     ...
     if ((event.body.toLowerCase() == "🥱")) {return api.sendMessage("𝗡𝐢𝐍𝐃 𝐀𝐑𝐄 𝐇𝐄 𝐓𝐎 𝐒𝐎 𝐉𝐀𝐎 𝐍𝐀 𝐊𝐢𝐒𝐊𝐀 𝐖𝐀𝐢𝐓 𝐊𝐀𝐑 𝐑𝐀𝐇𝐄 𝐇𝐎 𝐁𝐀𝐁𝐘 💨🌿🙄 ", threadID);
     };
  if ((event.body.toLowerCase() == "👌")) {return api.sendMessage("𝑻𝒖𝒔𝒊 𝒂𝒘𝒔𝒐𝒎𝒆 𝒉𝒐 𝒈👌👌 ", threadID);
    ...
    if ((event.body.toLowerCase() == "kis kar")) {return api.sendMessage(" ️sab dekh rahe hai wrna bhot kiss deti🙈 ", threadID);
     ...
     if ((event.body.toLowerCase() == "🤭")) {return api.sendMessage("😻🌿𝗔𝐒𝐀 𝐊𝐚𝐦 𝐍𝐚 𝐊𝐚𝐫𝐎 𝐉𝐢𝐬 𝐒𝐞 𝐌𝐮𝐡 𝐂𝐡𝐮𝐩𝐚𝐧𝐚 𝐏𝐚𝐃𝐞🤭🌿😻 ", threadID);
     };
  ...
  ((event.body.toLowerCase() == "morning") || (event.body.toLowerCase() == "good morning")) {
    ...
    if ((event.body.toLowerCase() == "☺️")) {return api.sendMessage("𝗪𝐀𝐇 𝐊𝐢𝐘A M𝐔𝐒𝐊𝐔𝐑𝐀𝐇𝐀𝐓 𝐇E 𝐀𝐏𝐊𝐢 🤭🤣", threadID);
     };
  ...
  if ((event.body.toLowerCase() == "😍😍😍")) {return api.sendMessage("🦋🌿Aƞƙɧ❍ Ɱɛ Ƥɣɑɽ͢  Ɗɪɭɱɛ Ƙɧuɱɑɽ🌬️🌍 ••Ƥɣɑɽ Ƭ❍ɧ Ƞɧɪ Ƙɒɽ ɭɪɣɑ Ɱuȷɧʂɛ>³••🕊️🍎😍 ", threadID);
    ...
    if ((event.body.toLowerCase() == "❤️")) {return api.sendMessage("𝗠E𝐊𝐎 K𝐀𝐋A 𝗗𝗶𝐋 𝐂𝐇AHI𝐘𝐄 🙂✨𝐋𝐀𝐋 𝐓𝐔𝐓 𝐉𝐀𝐓𝐀 𝐇E ", threadID);
     };

    if ((event.body.toLowerCase() == "🥰🥰🥰🥰")) {return api.sendMessage("【  𝐀𝐈𝐒𝐄 𝐌𝐀𝐓 𝐃𝐄𝐊𝐇0 𝐘𝐀𝐑 𝐍𝐀𝐇𝐈 𝗧𝗢 𝐊𝐈𝐒𝐒  𝐊𝐀𝐑 𝐋𝐔𝐍𝐆𝐀______😁😁😝】", threadID);
     };

  if ((event.body.toLowerCase() == "😍😍")) {return api.sendMessage("😻 ✄ I𝐒 𝐍A𝗭𝐀𝐑 𝐒𝐄 𝐌E𝐑E 𝐎𝐖NE𝐑 𝐒𝗔𝗠𝐄𝐄𝐑 𝐊𝐎 𝐃EK𝐇𝐎 🌬️☞𝐌A𝗝𝗔 𝐍𝗔 𝐀Y𝐄 😻 𝗧𝐎 𝐏AI𝐒𝐄 𝗪A𝐏I𝗦 🧡>³••🕊️🍎😍 ", threadID);
     };
  ...
  if ((event.body.toLowerCase() == "😎")) {return api.sendMessage("🌬️ ✄𝐂𝐡𝐚𝐒𝐦𝐚 𝐇𝐚𝐓𝐚𝐎 𝐧𝐚 𝐒𝐚𝐡𝐚𝐁 𝐊𝐢𝐘𝐚 𝐍𝐚𝐦𝟑 𝐇𝐚𝐢 𝐀𝐩𝐊𝐚  𝐊𝗮𝗹𝗹𝘂𝘆𝗲 😅", threadID);
     };
  ...
  if ((event.body.toLowerCase() == "🥰🥰")) {return api.sendMessage("🦋🌿Aƞƙɧ❍ Ɱɛ Ƥɣɑɽ͢  Ɗɪɭɱɛ Ƙɧuɱɑɽ🌬️🌍 ••Ƥɣɑɽ Ƭ❍ɧ Ƞɧɪ Ƙɒɽ ɭɪɣɑ Ɱuȷɧʂɛ>³••🕊️🍎😍", threadID);
    ...
    if ((event.body.toLowerCase() == "🫣")) {return api.sendMessage("🌬️👌𝗦𝗔𝐑𝐌𝐀𝐎 𝐌𝐀𝐓 AP𝐍𝐀 𝐇𝐢 𝐆𝐇𝐀𝐑 𝐒𝐀𝐌𝐉𝐇𝐎 😼 ", threadID);
     };

  if ((event.body.toLowerCase() == "🤤")) {return api.sendMessage("𝐊𝐘A 𝐇𝐔A 𝐓𝐔𝐉𝐇𝐄 𝐋𝐀𝐑 𝐊𝐢𝐔𝐍 𝐓𝐀𝐏𝐊𝐀 𝐑𝐇𝐀 𝐇𝐀I 𝐌𝐔J𝐇𝐄 𝐔𝐋𝐓I 𝐀𝐉𝐀𝐘𝐄 𝐆I 🤮🤢", threadID);
     };

  if ((event.body.toLowerCase() == "🙂")) {return api.sendMessage("😻🌿𝐇𝐘𝐄 𝐑𝐀𝐁𝐁𝐀 𝐈𝐓𝐍𝐀 𝐏𝐘𝐀𝐑😻", threadID);
     };
  ...
  if ((event.body.toLowerCase() == "🤣")) {return api.sendMessage("🌬️🌏🦋⃝⸺‣𝐒𝐚𝐊𝐚𝐋 𝐀𝐂𝐡𝐢 𝐍𝐚𝐡𝐢 𝐓𝐨 𝐇𝐚𝐒 𝐓𝐨 𝐀𝐂𝐡𝐚 𝐋𝐢𝐘𝐚 𝐊𝐚𝐑 𝐌𝐞𝐑𝐢 𝐉𝐚𝐚𝐧😄🤣", threadID);
    ...
    if ((event.body.toLowerCase() == "🤔") || (event.body.toLowerCase() == "🤨")) {
       return api.sendMessage("️😻🌿𝐢𝐓𝐍𝐀 𝐊𝐢𝐘𝐀 𝐒𝐎𝐂𝐇 𝐑𝐀𝐇𝐄😻", threadID);
     };
  ...
  if ((event.body.toLowerCase() == "🙈")) {return api.sendMessage("S𝐂𝐇 𝐌𝐄 BA𝐍𝐃𝐑 𝐇I 𝐇𝐄 👉🐒𝐂𝐇L𝐀 J𝐀🤣", threadID);
     };
  ...
  if ((event.body.toLowerCase() == "🤐")) {
    ...
    if ((event.body.toLowerCase() == "😒") || (event.body.toLowerCase() == "🙄")) {
       return api.sendMessage("️️🌬️➺𝐓𝐄𝐑𝐈 𝐓𝐎𝐅𝐅𝐢 𝐋𝐄𝐋I 𝐊I𝐒I𝐍𝐄 𝐉𝐎 AI𝐒A 𝐌𝐔𝐇 𝐁𝐀𝐍A 𝐋I𝐘A🤭🤣", threadID);
     };
